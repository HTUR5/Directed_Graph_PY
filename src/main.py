...
def check1():
    ...
    file = "../data/T0.json"
    g_algo.load_from_json('Scripts/T0.json')  # init a GraphAlgo from a json file
    print(g_algo.shortest_path(0, 3))
    print(g_algo.shortest_path(3, 1))
    print(g_algo.centerPoint())
    g_algo.save_to_json('Scripts/' + '_saved')
    g_algo.plot_graph()
...
def check2():
    ...
    g_algo = GraphAlgo()
    file = '../data/A5'
    g_algo.load_from_json('Scripts/A5.json')
    g_algo.get_graph().remove_edge(13, 14)
    g_algo.save_to_json('Scripts/' + "_edited")
